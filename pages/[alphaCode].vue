...
<template>
  <div class="pt-10 pb-5 px-3">
    <NuxtLink class="shadow-lg rounded bg-white px-3 py-1 dark:bg-dblue" to="/">
      Back
    </NuxtLink>
    <img :src="country.flags.svg" alt="" class="mt-11 mb-9" />
    ...
    <div class="flex flex-col gap-2">
      ...
      >
      <span
        ><span class="font-semibold">Region: </span>{{ country.region }}</span
      >
      <span
      ...
      >
      <span
        ><span class="font-semibold">Capital: </span>{{ country.capital }}</span
      >
      <br />
      <span
